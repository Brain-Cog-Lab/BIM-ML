...
import sys 
sys.path.append("/mnt/home/hexiang/MUSIC-AVQA/")   # path to your project root
...
def main():
    ...
    parser.add_argument(
        "--video_dir", type=str, default='/mnt/home/hexiang/MUSIC-AVQA/feats/res18_14x14/', help="video dir")
    parser.add_argument(
        "--st_dir", type=str, default='./data/feats/r2plus1d_18', help="video dir")

    parser.add_argument(
        "--label_train", type=str, default="/mnt/home/hexiang/MUSIC-AVQA/data/json/avqa-train_real.json", help="train csv file")
    parser.add_argument(
        "--label_val", type=str, default="/mnt/home/hexiang/MUSIC-AVQA/data/json/avqa-val_real.json", help="val csv file")
    parser.add_argument(
        "--label_test", type=str, default="/mnt/home/hexiang/MUSIC-AVQA/data/json/avqa-test_real.json", help="test csv file")
    parser.add_argument(
