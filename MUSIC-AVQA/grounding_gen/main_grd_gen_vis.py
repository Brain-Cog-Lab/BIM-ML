    ...
    with torch.no_grad():
        for batch_idx, sample in enumerate(val_loader):
            ...
            for j in range(obj_len):
                ...
                cv2.imwrite(os.path.join('/mnt/home/hexiang/MUSIC-AVQA/grounding_gen/models_grd_vis/vis_h4_c6', file_name), result)
...
def test(model, val_loader):
    ...
    total = 0
    correct = 0
    samples = json.load(open('/mnt/home/hexiang/MUSIC-AVQA/data/json/avqa-test_real.json', 'r'))
    A_count = []
    A_cmp = []
    V_count = []
    V_loc = []
...
def main():
    ...
    parser.add_argument(
        "--label_train", type=str, default="/mnt/home/hexiang/MUSIC-AVQA/data/json_update/avqa-train.json", help="train csv file")
    parser.add_argument(
        "--label_val", type=str, default="/mnt/home/hexiang/MUSIC-AVQA/data/json_update/avqa-val.json", help="val csv file")
    parser.add_argument(
        "--label_test", type=str, default="/mnt/home/hexiang/MUSIC-AVQA/data/json_update/avqa-test.json", help="test csv file")
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_save_dir", type=str, default='/mnt/home/hexiang/MUSIC-AVQA/grounding_gen/models_grounding_gen/', help="model save dir")
    parser.add_argument(
